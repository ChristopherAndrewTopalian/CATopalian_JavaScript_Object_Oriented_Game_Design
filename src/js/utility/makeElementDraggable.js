...
function makeElementDraggable(element)
{
    ...
    // add mousedown event to make element draggable
    element.onmousedown = createMouseDownHandler(element, state);
}

// make an element undraggable
function makeElementUndraggable(element)
{
    // remove mousedown event listener to stop dragging
    ge(element).onmousedown = null;

    // remove any other event listeners
    // such as mousemove and mouseup
    document.onmousemove = null;
    document.onmouseup = null;
}
